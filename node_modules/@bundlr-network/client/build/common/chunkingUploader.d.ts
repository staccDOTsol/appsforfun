...
export declare class ChunkingUploader extends EventEmitter {
    ...
    pause(): void;
    resume(): void;
    uploadTransaction(data: Readable | Buffer | DataItem): Promise<AxiosResponse<UploadResponse, any>>;
    uploadData(dataStream: Readable | Buffer, transactionOpts?: DataItemCreateOptions): Promise<AxiosResponse<UploadResponse, any>>;
