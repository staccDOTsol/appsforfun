...
class Fund {
    ...
    async fund(amount, multiplier = 1.0) {
        ...
        if (c.needsFee) {
            ...
            fee = bignumber_js_1.default.isBigNumber(baseFee) ? (baseFee.multipliedBy(multiplier)).toFixed(0).toString() : baseFee;
        }
        ...
        const bres = await (0, async_retry_1.default)(async (bail) => {
            ...
            if (bres.status == 400) {
                bail(new Error(`failed to post funding tx - ${tx.txId} (keep this id!) - ${bres.data} ${confirmError ? ` - ${(_a = confirmError === null || confirmError === void 0 ? void 0 : confirmError.message) !== null && _a !== void 0 ? _a : confirmError}` : ""}`));
            }
